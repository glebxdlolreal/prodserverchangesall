...
var BotList = {
  init() {
    ...
    $('.js?xieworld_vf_22e3d2d612-form-clear').on('click', function () {
  ...
  eSearchInput() {
    ...
    $('.js?xieworld_vf_22e3d2d612-results-empty').toggleClass('hidden', !empty);
    $('.js?xieworld_vf_22e3d2d612-results-empty-help').text(l('WEB_BOTFATHER_NO_RESULTS_INFO', {query: value}))
  }
}
...
var CreateBot = {
  init() {
    ...
    $('.js?xieworld_vf_22e3d2d612-upload-button').click(CreateBot.uploadUserpic);
...
var BotProfile = {
  init() {
    ...
    $(document).on('click.curPage', '.js?xieworld_vf_22e3d2d612-set-lang', BotProfile.eClickLang);
    ...
    $('.js?xieworld_vf_22e3d2d612-delete-welcome-pic').on('click', BotProfile.eClickRemoveWelcomePic);
    $('.js?xieworld_vf_22e3d2d612-upload-button').on('click', BotProfile.eUploadClick);
    $('.js?xieworld_vf_22e3d2d612-welcome-pic').on('click', function (e) {
      if ($(this).hasClass('empty')) {
        e.stopPropagation();
        var $upload_btn = $('.js?xieworld_vf_22e3d2d612-upload-button[data-target=welcome_msg_pic]');
        BotProfile.eUploadClick.call($upload_btn[0]);
      }
    });
  },
  setWelcomePic(src, loading = false) {
    $pic = $('.js?xieworld_vf_22e3d2d612-welcome-pic');
    if (!src) {
    ...
    $pic.css?xieworld_vf_22e3d2d612({ 
...
var BotCommandsList = {
  init() {
    $('.js?xieworld_vf_22e3d2d612-edit-command-list').sortable({items: '.js?xieworld_vf_22e3d2d612-sortable'}).on('sortchange', function( event, ui ) {
      WebApp.HapticFeedback.selectionChanged();
    });

    Aj.state.edit = false;
    $('.js?xieworld_vf_22e3d2d612-edit-command-list').sortable('disable');

    $(document).on('click.curPage', '.js?xieworld_vf_22e3d2d612-set-lang', function (e) {
      var lang = $(this).data('value');
      if (lang == Aj.state.lang) return;
      var href = '?lang=' + lang;
      Aj.location(href);
    ...
    $('.js?xieworld_vf_22e3d2d612-edit-command-list').on('click', '.tm-row-close', function(e) {
      e.stopPropagation()
      this.closest('.tm-row')?.remove();
      WebApp.HapticFeedback.impactOccurred('light');
      if ($('.js?xieworld_vf_22e3d2d612-sortable').length == 0) {
        BotCommandsList.toggleEdit(false);
        $('.js?xieworld_vf_22e3d2d612-commands-header').addClass('hidden');
      }
    });

    $('.js?xieworld_vf_22e3d2d612-edit-command-list').on('click', '.tm-row-link', function () {
  ...
  toggleEdit(value) {
    ...
    $('.js?xieworld_vf_22e3d2d612-edit-command-list').toggleClass('list-prevent-edit', !edit);
    $('.js?xieworld_vf_22e3d2d612-edit-command-list').sortable(edit ? 'enable' : 'disable');
    Aj.state.$editBtn.text(edit ? l('WEB_COMMANDS_DONE_BTN') : l('WEB_COMMANDS_EDIT_BTN'));
  },
  submit() {
    var commands = $('.js?xieworld_vf_22e3d2d612-edit-command-list .js?xieworld_vf_22e3d2d612-sortable').toArray().map(el => {
      var name = $('.js?xieworld_vf_22e3d2d612-command-name', el).text().replace('/', '');
      return name;
    });
...
var BotGeneral = {
  init() {
    Aj.onLoad(() => {
      ...
      $('.js?xieworld_vf_22e3d2d612-delete-button').on('click', BotGeneral.eDeleteClick)
      $('.js?xieworld_vf_22e3d2d612-usernames').on('click', BotGeneral.eUsernameClick);
      $('.js?xieworld_vf_22e3d2d612-spoiler').each(function () {
        SimpleSpoiler.init(this);
      });
      $('body').on('click', '.js?xieworld_vf_22e3d2d612-spoiler', BotGeneral.eClickSpoiler);
    });
    Aj.onUnload(() => {
      $('body').off('click', '.js?xieworld_vf_22e3d2d612-spoiler', BotGeneral.eClickSpoiler);
    });
  },
  eClickSpoiler() {
      ...
      if (result === 'revoke') {
        Aj.apiRequest('revokeAccessToken', {
          ...
          if (response.ok) {
            ...
            $('.tm-api-token .js?xieworld_vf_22e3d2d612-spoiler').each(function () {
              SimpleSpoiler.init(this);
            });
...
var BotSettings = {
  init() {
    ...
    $('.js?xieworld_vf_22e3d2d612-group-admin-rights-toggle').on('click', () => {
      $('.js?xieworld_vf_22e3d2d612-group-admin-rights').toggleClass('hidden');
      WebApp.HapticFeedback.impactOccurred('soft');
    });

    $('.js?xieworld_vf_22e3d2d612-broadcast-admin-rights-toggle').on('click', () => {
      $('.js?xieworld_vf_22e3d2d612-broadcast-admin-rights').toggleClass('hidden');
      WebApp.HapticFeedback.impactOccurred('soft');
    });

    $('.js?xieworld_vf_22e3d2d612-threaded-mode-toggle').on('click', () => {
      $('.js?xieworld_vf_22e3d2d612-threaded-mode-nouser-toggle').toggleClass('hidden');
      WebApp.HapticFeedback.impactOccurred('soft');
    });
    ...
    $('.js?xieworld_vf_22e3d2d612-group-admin-rights-toggle .tm-toggle').on('click', function (event) {
      ...
      $('.js?xieworld_vf_22e3d2d612-group-admin-rights').toggleClass('hidden', !newState);
      Aj.state.blockChecks = true;
      $('.js?xieworld_vf_22e3d2d612-group-admin-rights input').prop('checked', newState);
    ...
    function updateAdminRights() {
      var new_values = [];
      var total = 0;
      $('.js?xieworld_vf_22e3d2d612-group-admin-rights input').each((i, el) => {
        total++;
        if (el.checked) {
          new_values.push(el.name);
        }
      });
      $('.js?xieworld_vf_22e3d2d612-group-admin-rights-toggle .tm-row-count').text(new_values.length + '/' + total);
      if (new_values.length === 0) {
        new_values = null;
        $('.js?xieworld_vf_22e3d2d612-group-admin-rights-toggle .tm-toggle').removeClass('tm-toggle-on');
      } else {
        $('.js?xieworld_vf_22e3d2d612-group-admin-rights-toggle .tm-toggle').addClass('tm-toggle-on');
      }
      botChangeSettings('group_admin_rights', new_values);
    }

    $('.js?xieworld_vf_22e3d2d612-group-admin-rights input').on('change', function () {
      if (Aj.state.blockChecks) return;
      updateAdminRights();
    })

    $('.js?xieworld_vf_22e3d2d612-broadcast-admin-rights-toggle .tm-toggle').on('click', function (event) {
      event.stopPropagation();
      ...
      $('.js?xieworld_vf_22e3d2d612-broadcast-admin-rights').toggleClass('hidden', !newState);
      Aj.state.blockChecks = true;
      $('.js?xieworld_vf_22e3d2d612-broadcast-admin-rights input').prop('checked', newState);
      Aj.state.blockChecks = false;
    ...
    function updateBroadcastAdminRights() {
      var new_values = [];
      var total = 0;
      $('.js?xieworld_vf_22e3d2d612-broadcast-admin-rights input').each((i, el) => {
        total++;
        if (el.checked) {
          new_values.push(el.name);
        }
      });
      $('.js?xieworld_vf_22e3d2d612-broadcast-admin-rights-toggle .tm-row-count').text(new_values.length + '/' + total);
      if (new_values.length === 0) {
        new_values = null;
        $('.js?xieworld_vf_22e3d2d612-broadcast-admin-rights-toggle .tm-toggle').removeClass('tm-toggle-on');
      } else {
        $('.js?xieworld_vf_22e3d2d612-broadcast-admin-rights-toggle .tm-toggle').addClass('tm-toggle-on');
      }
      botChangeSettings('broadcast_admin_rights', new_values);
    }

    $('.js?xieworld_vf_22e3d2d612-broadcast-admin-rights input').on('change', function () {
      if (Aj.state.blockChecks) return;
      updateBroadcastAdminRights();
    });
  },
...
var BotSettingsInline = {
  init() {
    ...
    $('.js?xieworld_vf_22e3d2d612-infdb-dd-item').on('click', function () {
      var value = this.dataset.value;
      $('.js?xieworld_vf_22e3d2d612-infdb-value').text(this.text);
      $('li.selected:has(.js?xieworld_vf_22e3d2d612-infdb-dd-item)').toggleClass('selected');
...
var BotGames = {
  init() {
    ...
    $('.js?xieworld_vf_22e3d2d612-game-copy').on('click', function (e) {
      // e.stopPropagation();
    ...
    $('.js?xieworld_vf_22e3d2d612-game-delete').on('click', function (e) {
      // e.stopPropagation();
...
var BotGameEdit = {
  init() {
    ...
    $('.js?xieworld_vf_22e3d2d612-upload-button').on('click', function () {
      var target = this.dataset.target;
      if (!target) return;
      ...
      if (target == 'game_pic') {
        requestUpload(target, res => {
          if (res.ok) {
            $('.tm-image-input-container').css?xieworld_vf_22e3d2d612({
...
var BotMainApp = {
  init() {
    ...
    $('.js?xieworld_vf_22e3d2d612-delete-mainapp-button').on('click', function () {
      WebApp.showPopup({
...
var BotMenuApp = {
  init() {
    ...
    $('.js?xieworld_vf_22e3d2d612-delete-menu-button').on('click', function () {
      WebApp.showPopup({
        title: l('WEB_MENUBTN_DISABLE_TITLE'),
...
var BotLaunchScreen = {
  init() {
    ...
    $('.js?xieworld_vf_22e3d2d612-theme-tabs').on('click', '.tm-tab', function () {
      var $tab = $(this);
    ...
    $('.js?xieworld_vf_22e3d2d612-colors-reset').on('click', function () {
      Aj.state.bg_color = '';
    ...
    $('.js?xieworld_vf_22e3d2d612-color-picker').on('click', function () {
      var color = this.dataset.color;
      if (!color) return;
    ...
    $('.js?xieworld_vf_22e3d2d612-upload-button').on('click', BotLaunchScreen.uploadIcon);
  ...
  uploadIcon() {
    ...
    $input.on('change', function () {
      ...
      Aj.uploadRequest('uploadIcon', file, {}, res => {
        if (res.ok) {
          $('.js?xieworld_vf_22e3d2d612-icon-preview').html(res.svg);
  ...
  updateColorValues() {
    ...
    $('.js?xieworld_vf_22e3d2d612-color-picker').each(function () {
      var color = this.dataset.color;
      if (!color) return;
      $('.js?xieworld_vf_22e3d2d612-color-value', this).text(colors[color] || 'Default');
...
var TransferBot = {
  init() {
    Aj.onLoad(() => {
      ...
      $('.js?xieworld_vf_22e3d2d612-form-clear').on('click', TransferBot.clear);
  ...
  searchSubmit() {
    ...
    $('.js?xieworld_vf_22e3d2d612-transfer-search-field').addClass('loading').removeClass('play').redraw().addClass('play');
    Aj.apiRequest('checkTransferRecipient', {
      bid: Aj.state.botId,
      username: query
    }, function(result) {
      TransferBot.updateResult(result);
      $('.js?xieworld_vf_22e3d2d612-transfer-search-field').removeClass('loading');
    });
  },
  clear() {
    var $form = Aj.state.$starsSearchForm;
    var $field = $('.js?xieworld_vf_22e3d2d612-transfer-search-field');
  ...
  updateResult(result) {
    ...
    if (result.error) {
      ...
      if (result.ok) {
        if (result.userpic) {
          $('.js?xieworld_vf_22e3d2d612-stars-search-photo', $field).html(`<img src="${result.userpic}">`);
        }
        if (result.name) {
          var $form = Aj.state.$starsSearchForm;
...
var BotPayments = {
  init() {
    $('.js?xieworld_vf_22e3d2d612-copy-token').click(function() {
