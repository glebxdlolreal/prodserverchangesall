...
var Cafe = {
  ...
  init: function(options) {
    ...
    $('.js?xieworld_vf_1701b089f8-item-lottie').on('click', Cafe.eLottieClicked);
    $('.js?xieworld_vf_1701b089f8-item-incr-btn').on('click', Cafe.eIncrClicked);
    $('.js?xieworld_vf_1701b089f8-item-decr-btn').on('click', Cafe.eDecrClicked);
    $('.js?xieworld_vf_1701b089f8-item-buy-btn').on('click', Cafe.eBuyClicked);
    $('.js?xieworld_vf_1701b089f8-order-edit').on('click', Cafe.eEditClicked);
    $('.js?xieworld_vf_1701b089f8-status').on('click', Cafe.eStatusClicked);
    $('.js?xieworld_vf_1701b089f8-order-comment-field').each(function() {
      autosize(this);
    });
  ...
  initLotties: function() {
    $('.js?xieworld_vf_1701b089f8-item-lottie').each(function() {
      RLottie.init(this, {
        maxDeviceRatio: 2,
        cachingModulo: 3,
        noAutoPlay: true
  ...
  eIncrClicked: function(e) {
    ...
    var itemEl = $(this).parents('.js?xieworld_vf_1701b089f8-item');
  ...
  getOrderItem: function(itemEl) {
    ...
    return $('.js?xieworld_vf_1701b089f8-order-item').filter(function() {
  ...
  updateItem: function(itemEl, delta) {
    ...
    var counterEl = $('.js?xieworld_vf_1701b089f8-item-counter', itemEl);
    counterEl.text(count ? count : 1);
    var isSelected = itemEl.hasClass('selected');
    if (!isSelected && count > 0) {
      $('.js?xieworld_vf_1701b089f8-item-lottie', itemEl).each(function() {
        RLottie.playOnce(this);
      });
    }
    var anim_name = isSelected ? (delta > 0 ? 'badge-incr' : (count > 0 ? 'badge-decr' : 'badge-hide')) : 'badge-show';
    var cur_anim_name = counterEl.css?xieworld_vf_1701b089f8('animation-name');
    if ((anim_name == 'badge-incr' || anim_name == 'badge-decr') && anim_name == cur_anim_name) {
      anim_name += '2';
    }
    counterEl.css?xieworld_vf_1701b089f8('animation-name', anim_name);
    itemEl.toggleClass('selected', count > 0);

    var orderItemEl = Cafe.getOrderItem(itemEl);
    var orderCounterEl = $('.js?xieworld_vf_1701b089f8-order-item-counter', orderItemEl);
    orderCounterEl.text(count ? count : 1);
    orderItemEl.toggleClass('selected', count > 0);
    var orderPriceEl = $('.js?xieworld_vf_1701b089f8-order-item-price', orderItemEl);
  ...
  updateTotalPrice: function() {
    var total_price = 0;
    $('.js?xieworld_vf_1701b089f8-item').each(function() {
      var itemEl = $(this)
      var price = +itemEl.data('item-price');
      var count = +itemEl.data('item-count') || 0;
  ...
  toggleMode: function(mode_order) {
    ...
    if (mode_order) {
      ...
      $('.cafe-items').css?xieworld_vf_1701b089f8('maxHeight', height).redraw();
      ...
      setTimeout(function() {
        $('.cafe-items').css?xieworld_vf_1701b089f8('maxHeight', '');
  ...
  mainBtnClicked: function() {
    ...
    if (Cafe.modeOrder) {
      var comment = $('.js?xieworld_vf_1701b089f8-order-comment-field').val();
      var params = {
  ...
  showStatus: function(text) {
    ...
    $('.js?xieworld_vf_1701b089f8-status').text(text).addClass('shown');
    if (!Cafe.isClosed) {
  ...
  hideStatus: function() {
    clearTimeout(Cafe.statusTo);
    $('.js?xieworld_vf_1701b089f8-status').removeClass('shown');
  },
