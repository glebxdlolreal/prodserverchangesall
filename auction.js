...
var Main = {
  ...
  init: function() {
    Aj.onLoad(function(state) {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-logo-hoverable').on('mouseover', Main.ePlayLogo);
      $('.js?xieworld_vf_e3fbb5f01b-logo-clickable').on('click', Main.ePlayLogo);
      $('.js?xieworld_vf_e3fbb5f01b-logo-icon').on('animationend', Main.eLogoAnimEnd);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-header-menu-button', Main.eHeaderMenu);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-header-menu-close-button', Main.eHeaderMenuClose);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-btn-tonkeeper', Main.eTonkeeperOpen);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-auction-unavail', Main.eAuctionUnavailable);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-howitworks', Main.eHowitworks);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-howofferworks', Main.eHowofferworks);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-bots-about', Main.eBotsAbout);
      ...
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-copy-code', Main.copyCode);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-lottie[playbyclick]', Main.playLottieByClick);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-main-search-dd-item', Main.eMainSearchDDSelected);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-choose-collection-item', Main.eChooseCollectionSelected);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-main-filters-header', Main.eMainFiltersToggle);
      $('.js?xieworld_vf_e3fbb5f01b-main-filter-search-field').on('input', Main.eMainFiltersSearch);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-main-filter-search-clear', Main.eMainFiltersClear);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-choose-collection-btn', Main.eChooseCollectionOpen);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-choose-filters-btn', Main.eChooseFiltersOpen);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-attribute-item .js?xieworld_vf_e3fbb5f01b-attribute-checkbox', Main.eChooseAttributeCheckbox);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-attribute-item', Main.eChooseAttributeValue);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-attribute-all', Main.eChooseAttributeAll);
      state.$headerMenu = $('.js?xieworld_vf_e3fbb5f01b-header-menu');
      state.$unavailPopup = $('.js?xieworld_vf_e3fbb5f01b-unavailable-popup');
      state.$howitworksPopup = $('.js?xieworld_vf_e3fbb5f01b-howitworks-popup');
      state.$howofferworksPopup = $('.js?xieworld_vf_e3fbb5f01b-howofferworks-popup');
      state.$botsaboutPopup = $('.js?xieworld_vf_e3fbb5f01b-botsabout-popup');
      state.$chooseCollectionPopup = $('.js?xieworld_vf_e3fbb5f01b-choose-collection-popup');
      state.$chooseFiltersPopup = $('.js?xieworld_vf_e3fbb5f01b-choose-filters-popup');
      state.$mainSearchField = $('.js?xieworld_vf_e3fbb5f01b-main-search-field');
      state.$mainSearchForm = $('.js?xieworld_vf_e3fbb5f01b-main-search-form');
      ...
      $('.js?xieworld_vf_e3fbb5f01b-form-clear', state.$mainSearchForm).on('click', Main.eMainSearchClear);
      $('.js?xieworld_vf_e3fbb5f01b-x-scrollable').on('scroll', Main.eXScrollableUpdate);
      $('.js?xieworld_vf_e3fbb5f01b-y-scrollable').on('scroll', Main.eYScrollableUpdate);
    ...
    Aj.onUnload(function(state) {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-logo-hoverable').off('mouseover', Main.ePlayLogo);
      $('.js?xieworld_vf_e3fbb5f01b-logo-clickable').off('click', Main.ePlayLogo);
      $('.js?xieworld_vf_e3fbb5f01b-logo-icon').off('animationend', Main.eLogoAnimEnd);
      $('.js?xieworld_vf_e3fbb5f01b-main-filter-search-field').off('input', Main.eMainFiltersSearch);
      state.$mainSearchForm.off('submit', Main.eMainSearchSubmit);
      state.$mainSearchForm.field('query').off('input', Main.eMainSearchInput);
      $('.js?xieworld_vf_e3fbb5f01b-form-clear', state.$mainSearchForm).off('click', Main.eMainSearchClear);
      $('.js?xieworld_vf_e3fbb5f01b-x-scrollable').off('scroll', Main.eXScrollableUpdate);
      $('.js?xieworld_vf_e3fbb5f01b-y-scrollable').off('scroll', Main.eYScrollableUpdate);
  ...
  onMainSearchFormScroll: function() {
    $('.js?xieworld_vf_e3fbb5f01b-load-more', Aj.ajContainer).each(function() {
      var $loadMore = $(this);
  ...
  initForm: function(form) {
    ...
    $('.js?xieworld_vf_e3fbb5f01b-amount-input', $form).on('keyup change input', Main.eUpdateAmountField);
    $('.js?xieworld_vf_e3fbb5f01b-amount-input', $form).trigger('input');
  },
  destroyForm: function(form) {
    var $form = $(form);
    $('.form-control:has(+.form-control-hint)', $form).off('keyup change input', Main.eUpdateFieldHint);
    $('.js?xieworld_vf_e3fbb5f01b-amount-input', $form).off('keyup change input', Main.eUpdateAmountField);
  },
  updateTime: function() {
    ...
    if (Main._lastUpdateTime != now) {
      ...
      $('time[datetime]', Aj.ajContainer).each(function () {
        ...
        if (mode) {
          ...
          $(this).closest('.js?xieworld_vf_e3fbb5f01b-timer-wrap').toggleClass('ended', ended);
        } else {
  ...
  fitUsername: function($el) {
    $el.each(function(){
      ...
      if (!init_size) {
        init_size = parseInt($(this).css?xieworld_vf_e3fbb5f01b('font-size'));
        $(this).data('init-size', init_size);
      }
      var size = parseInt($(this).css?xieworld_vf_e3fbb5f01b('font-size'));
      size = parseInt(size);
      while (this.scrollWidth > this.offsetWidth) {
        size -= 0.5;
        if (size >= init_size * 0.65) {
          $(this).css?xieworld_vf_e3fbb5f01b('font-size', size + 'px');
        } else {
          break;
        }
      }
  ...
  initViewport: function() {
    if (!window.$viewportHelper) {
      window.$viewportHelper = $('<div>').css?xieworld_vf_e3fbb5f01b({position: 'absolute', left: '-100px', top: '0', height: '100vh'}).appendTo('body');
    }
    Main.onResize();
  },
  onResize: function() {
  ...
  initLogo: function() {
    if (!Aj.globalState.logoInited) {
      ...
      mainLogo.onload = function() {
        ...
        $('.js?xieworld_vf_e3fbb5f01b-header-logo').each(function() {
  ...
  eLogoAnimEnd: function(e) {
    $(this).parents('.js?xieworld_vf_e3fbb5f01b-logo').removeClass('play');
  },
  ...
  eXScrollablesUpdate: function() {
    $('.js?xieworld_vf_e3fbb5f01b-x-scrollable').each(function() {
  ...
  eYScrollablesUpdate: function() {
    $('.js?xieworld_vf_e3fbb5f01b-y-scrollable').each(function() {
  ...
  eAuctionUnavailable: function(e) {
    ...
    openPopup(Aj.state.$unavailPopup, {
      onOpen: function() {
        $('.js?xieworld_vf_e3fbb5f01b-username', this).html(username);
        $('.js?xieworld_vf_e3fbb5f01b-unavailable-text', this).toggleClass('hide', !!later);
        $('.js?xieworld_vf_e3fbb5f01b-available-later-text', this).toggleClass('hide', !later);
        $(document).on('keydown', onEnterPress);
      },
      onClose: function() {
        $(document).off('keydown', onEnterPress);
  ...
  copyText: function(text) {
    var $text = $('<textarea readonly>').css?xieworld_vf_e3fbb5f01b('position', 'fixed').css?xieworld_vf_e3fbb5f01b('left', '-9999px');
  ...
  openApp: function(app_url) {
    if (Aj.state.appUseIframe) {
      var $frame = $('<iframe>').css?xieworld_vf_e3fbb5f01b('position', 'fixed').css?xieworld_vf_e3fbb5f01b('left', '-9999px');
      $frame.appendTo('body');
  ...
  initMainFilters: function(cont) {
    $('.js?xieworld_vf_e3fbb5f01b-main-filters-content', cont).each(function() {
      $('.js?xieworld_vf_e3fbb5f01b-choose-collection-item.selected', this).scrollIntoView({position: 'top', padding: 38});
      $('.js?xieworld_vf_e3fbb5f01b-attribute-item:has(input.checkbox:checked)', this).scrollIntoView({position: 'top', padding: 38});
    });
  },
  eMainFiltersToggle: function(e) {
    e.preventDefault();
    e.stopImmediatePropagation();
    var $boxEl = $(this).parents('.js?xieworld_vf_e3fbb5f01b-main-filters-box');
    var $contentEl = $('.js?xieworld_vf_e3fbb5f01b-main-filters-content', $boxEl);
    var isOpened = $boxEl.hasClass('opened');
    $contentEl.prepareSlideY(function() {
      if (!isOpened) {
        var $field = $('.js?xieworld_vf_e3fbb5f01b-main-filter-search-field', $contentEl);
        $field.focus();
      }
    });
  ...
  eMainFiltersSearch: function(e) {
    ...
    var $content = $(this).parents('.js?xieworld_vf_e3fbb5f01b-main-filters-content');
    var $items = $('.js?xieworld_vf_e3fbb5f01b-filter-item', $content);
  ...
  eMainFiltersClear: function(e) {
    ...
    var $content = $(this).parents('.js?xieworld_vf_e3fbb5f01b-main-filters-content');
    var $items = $('.js?xieworld_vf_e3fbb5f01b-filter-item', $content);
    var $field = $('.js?xieworld_vf_e3fbb5f01b-main-filter-search-field', $content);
    $items.each(function() {
  ...
  eChooseAttributeCheckbox: function(e) {
    e.preventDefault();
    e.stopImmediatePropagation();
    var $attr   = $(this).parents('.js?xieworld_vf_e3fbb5f01b-attribute');
    var $items  = $('.js?xieworld_vf_e3fbb5f01b-attribute-item', $attr);
    var $cur_cb = $('input.checkbox', this);
    var $all_cb = $('.js?xieworld_vf_e3fbb5f01b-attribute-all input.checkbox', $attr);
  ...
  eChooseAttributeAll: function(e) {
    ...
    e.stopImmediatePropagation();
    var $attr = $(this).parents('.js?xieworld_vf_e3fbb5f01b-attribute');
    $('.js?xieworld_vf_e3fbb5f01b-attribute-item', $attr).each(function() {
  ...
  updateAttributeValue: function($attr) {
    var $all_cb = $('.js?xieworld_vf_e3fbb5f01b-attribute-all input.checkbox', $attr);
    var $items  = $('.js?xieworld_vf_e3fbb5f01b-attribute-item', $attr);
    var $cntEl  = $('.js?xieworld_vf_e3fbb5f01b-filter-cnt', $attr);
  ...
  updateResults: function(result) {
    if (result.html) {
      $('.js?xieworld_vf_e3fbb5f01b-search-results', Aj.ajContainer).html(result.html);
      Main.updateTime();
      var loc = Aj.location(), path = loc.pathname + loc.search;
      Aj.setLocation(result.url, path != '/');
    }
    else if (result.part) {
      var $body = $('.js?xieworld_vf_e3fbb5f01b-search-results .js?xieworld_vf_e3fbb5f01b-autoscroll-body', Aj.ajContainer);
      var $foot = $('.js?xieworld_vf_e3fbb5f01b-search-results .js?xieworld_vf_e3fbb5f01b-autoscroll-foot', Aj.ajContainer);
      if (result.body) {
        $('.js?xieworld_vf_e3fbb5f01b-autoscroll-trash', $body).remove();
        $body.append(result.body);
      }
      $foot.html(result.foot);
      Main.updateTime();
    }
    $('.js?xieworld_vf_e3fbb5f01b-main-recent-bids').toggleClass('hide', !result.show_recent_bids);
  },
  ...
  initLottie: function(cont) {
    $('.js?xieworld_vf_e3fbb5f01b-lottie', cont || Aj.ajContainer).each(function() {
      RLottie.init(this, {
    ...
    if (Aj.globalState.tonConnectVersion == 2) {
      ...
      if (!tonConnectUI) {
        tonConnectUI = Aj.globalState.tonConnectUI = new TON_CONNECT_UI.TonConnectUI({
          manifestUrl: location.origin + '/tonconnect-manifest.js?xieworld_vf_e3fbb5f01bon',
...
var Auction = {
  init: function() {
    Aj.onLoad(function(state) {
      var cont = Aj.ajContainer;
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-place-bid-btn', Auction.ePlaceBid);
      $(cont).on('submit.curPage', '.js?xieworld_vf_e3fbb5f01b-place-bid-form', Auction.ePlaceBidSubmit);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-make-offer-btn', Auction.eMakeOffer);
      $(cont).on('submit.curPage', '.js?xieworld_vf_e3fbb5f01b-make-offer-form', Auction.eMakeOfferSubmit);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-buy-now-btn', Auction.eBuyNow);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-subscribe-btn', Auction.eSubscribe);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-unsubscribe-btn', Auction.eUnsubscribe);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-load-more-orders', Auction.eLoadMoreOrders);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-load-more-owners', Auction.eLoadMoreOwners);
      state.$bidPopup = $('.js?xieworld_vf_e3fbb5f01b-place-bid-popup');
      state.$bidForm = $('.js?xieworld_vf_e3fbb5f01b-place-bid-form');
      Main.initForm(state.$bidForm);
      state.$makeOfferPopup = $('.js?xieworld_vf_e3fbb5f01b-make-offer-popup');
      state.$makeOfferForm = $('.js?xieworld_vf_e3fbb5f01b-make-offer-form');
  ...
  updateState: function() {
    ...
    if (document.hasFocus() ||
      ...
      Aj.apiRequest('updateAuction', {
        ...
        if (result.html) {
          $('.js?xieworld_vf_e3fbb5f01b-main-content').html(result.html);
        }
        if (result.lt) {
  ...
  eMakeOffer: function(e) {
    ...
    Aj.apiRequest('initOfferRequest', {
      ...
      var eUpdateOfferFee = function(e) {
        ...
        $('.js?xieworld_vf_e3fbb5f01b-amount_fee', Aj.state.$makeOfferForm).html(Aj.state.offerFee);
      };
  ...
  eMakeOfferSubmit: function(e) {
    ...
    Wallet.sendTransaction({
      ...
      onDataUpdate: function(data) {
        $('.js?xieworld_vf_e3fbb5f01b-amount_fee', this).html(data.fee);
      },
      onConfirm: function(by_server) {
        if (by_server) {
  ...
  eSubscribe: function(e) {
    ...
    Aj.apiRequest('subscribe', {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-subscribe').addClass('subscribed');
    });
  },
  eUnsubscribe: function(e) {
    ...
    Aj.apiRequest('unsubscribe', {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-subscribe').removeClass('subscribed');
    });
  },
...
var Assets = {
  init: function() {
    Aj.onLoad(function(state) {
      $(document).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-assign-btn', Assets.eAssignToTelegram);
      $(document).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-assign-disable', Assets.eAssignDisable);
      $(document).on('submit.curPage', '.js?xieworld_vf_e3fbb5f01b-assign-form', Assets.eAssignSubmit);
      $(document).on('submit.curPage', '.js?xieworld_vf_e3fbb5f01b-bot-username-form', Assets.eBotUsernameSubmit);
      $(document).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-follow-link', Assets.eFollowLink);
      $(document).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-put-to-auction-btn', Assets.ePutToAuction);
      $(document).on('submit.curPage', '.js?xieworld_vf_e3fbb5f01b-put-to-auction-form', Assets.ePutToAuctionSubmit);
      $(document).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-cancel-auction-btn', Assets.eCancelAuction);
      $(document).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-sell-username-btn', Assets.eSellUsername);
      $(document).on('submit.curPage', '.js?xieworld_vf_e3fbb5f01b-sell-username-form', Assets.eSellUsernameSubmit);
      state.$assignPopup = $('.js?xieworld_vf_e3fbb5f01b-assign-popup');
      state.$assignForm = $('.js?xieworld_vf_e3fbb5f01b-assign-form');
      state.$botUsernamePopup = $('.js?xieworld_vf_e3fbb5f01b-bot-username-popup');
      state.$botUsernameForm = $('.js?xieworld_vf_e3fbb5f01b-bot-username-form');
      state.$botUsernameWaitingPopup = $('.js?xieworld_vf_e3fbb5f01b-bot-username-waiting-popup');

      state.$assetsField = $('.js?xieworld_vf_e3fbb5f01b-assets-search-field');
      $(document).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-assets-search-clear', Assets.eAssetsSearchClear);
      state.$assetsResults = $('.js?xieworld_vf_e3fbb5f01b-assets-table-body');
      ...
      state.$putToAuctionPopup = $('.js?xieworld_vf_e3fbb5f01b-put-to-auction-popup');
      state.$putToAuctionForm = $('.js?xieworld_vf_e3fbb5f01b-put-to-auction-form');
      Main.initForm(state.$putToAuctionForm);
      state.$sellUsernamePopup = $('.js?xieworld_vf_e3fbb5f01b-sell-username-popup');
      state.$sellUsernameForm = $('.js?xieworld_vf_e3fbb5f01b-sell-username-form');
  ...
  eAssignToTelegram: function(e) {
    ...
    e.preventDefault();
    $(this).closeDropdown();
    var $actions    = $(this).closest('.js?xieworld_vf_e3fbb5f01b-actions');
    ...
    openPopup(Aj.state.$assignPopup, {
      onOpen: function() {
        ...
        $('.js?xieworld_vf_e3fbb5f01b-item-title', Aj.state.$assignPopup).html(item_title);
        $('.js?xieworld_vf_e3fbb5f01b-item-thumb', Aj.state.$assignPopup).attr('src', '').redraw().attr('src', item_thumb);
        $('.js?xieworld_vf_e3fbb5f01b-assign-account-item.external').addClass('hide');
        $('.js?xieworld_vf_e3fbb5f01b-assign-disable').toggleClass('hide', !assigned_to);
        if (assigned_to) {
          $('.js?xieworld_vf_e3fbb5f01b-assign-account-item:has(input[name="assign_to"][value="' + assigned_to + '"])', Aj.state.$assignPopup).each(function() {
  ...
  assignToTelegram: function(username, assign_to) {
    Aj.apiRequest('assignToTgAccount', {
      ...
      if (result.waiting) {
        ...
        $('.js?xieworld_vf_e3fbb5f01b-username', Aj.state.$botUsernamePopup).html('@' + result.username);
        $('.js?xieworld_vf_e3fbb5f01b-amount', Aj.state.$botUsernamePopup).html(result.amount);
        Aj.state.$botUsernameForm.field('id').value(result.req_id);
        openPopup(Aj.state.$botUsernamePopup);
      } else {
        closePopup();
        $('.js?xieworld_vf_e3fbb5f01b-actions', Aj.ajContainer).each(function() {
          if ($(this).attr('data-username') == username) {
            $(this).attr('data-assigned-to', assign_to);
            if (result.assign_name) {
              $('.js?xieworld_vf_e3fbb5f01b-assigned-to', this).html(result.assign_name);
            }
          }
        });
        if (result.msg) {
  ...
  ePutToAuction: function(e) {
    ...
    var doPutToAuction = function() {
      $('.js?xieworld_vf_e3fbb5f01b-username', Aj.state.$putToAuctionPopup).html(item_title);
      $('.js?xieworld_vf_e3fbb5f01b-item-thumb', Aj.state.$putToAuctionPopup).attr('src', '').redraw().attr('src', item_thumb);
  ...
  eSellUsername: function(e) {
    ...
    var doSellUsername = function() {
      $('.js?xieworld_vf_e3fbb5f01b-username', Aj.state.$sellUsernamePopup).html(item_title);
      $('.js?xieworld_vf_e3fbb5f01b-item-thumb', Aj.state.$sellUsernamePopup).attr('src', '').redraw().attr('src', item_thumb);
...
var Random = {
  init: function() {
    Aj.onLoad(function(state) {
      var cont = Aj.ajContainer;
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-buy-random-btn', Random.eBuyRandom);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-buy-more-random-btn', Random.eBuyMoreRandom);
      state.updLastReq = +Date.now();
      if (state.needUpdate) {
        state.updStateTo = setTimeout(Random.updateState, Main.UPDATE_PERIOD);
      }
      $('.js?xieworld_vf_e3fbb5f01b-spoiler', cont).each(function() {
  ...
  updateContent: function(html) {
    var $main = $('.js?xieworld_vf_e3fbb5f01b-main-content');
    $('.js?xieworld_vf_e3fbb5f01b-spoiler', $main).each(function() {
      SimpleSpoiler.destroy(this);
    });
    $('.js?xieworld_vf_e3fbb5f01b-main-content').html(html);
    $('.js?xieworld_vf_e3fbb5f01b-spoiler', $main).each(function() {
      SimpleSpoiler.init(this);
    }).removeClass('blured');
  },
  ...
  eBuyRandom: function(e) {
    ...
    Wallet.sendTransaction({
      ...
      onOpen: function() {
        $('.js?xieworld_vf_e3fbb5f01b-spoiler', this).each(function() {
          SimpleSpoiler.init(this);
        }).removeClass('blured');
      },
      onClose: function() {
...
var LoginCodes = {
  init: function() {
    Aj.onLoad(function(state) {
      var cont = Aj.ajContainer;
      $(cont).on('change.curPage', '.js?xieworld_vf_e3fbb5f01b-toggle-receive', LoginCodes.eToggleReceive);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-terminate-sessions-btn', LoginCodes.eTerminateSessions);
      state.needUpdate = true;
      state.updLastReq = +Date.now();
  ...
  eToggleReceive: function() {
    ...
    $('.js?xieworld_vf_e3fbb5f01b-codes-main').toggleClass('codes-disabled', !can_receive);
  ...
  terminateSessions: function(terminate_hash) {
    Aj.apiRequest('terminatePhoneSessions', {
      ...
      if (result.error) {
        ...
        $('.js?xieworld_vf_e3fbb5f01b-terminate-sessions-wrap').hide();
        if (result.msg) {
          showAlert(result.msg);
        }
      }
...
var Account = {
  init: function() {
    Aj.onLoad(function(state) {
      var cont = Aj.ajContainer;
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-convert-btn', Account.eConvertInit);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-revert-btn', Account.eConvertRevert);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-move-request-btn', Account.eMoveRequestInit);
      $(cont).on('submit.curPage', '.js?xieworld_vf_e3fbb5f01b-convert-bid-form', Account.eConvertBidSubmit);
      $(cont).on('submit.curPage', '.js?xieworld_vf_e3fbb5f01b-new-convert-bid-form', Account.eConvertBidSubmit);
      state.$convertBidPopup = $('.js?xieworld_vf_e3fbb5f01b-convert-bid-popup');
      state.$newConvertBidPopup = $('.js?xieworld_vf_e3fbb5f01b-new-convert-bid-popup');
      state.$convertBidForm = $('.js?xieworld_vf_e3fbb5f01b-convert-bid-form');
      state.$newConvertBidForm = $('.js?xieworld_vf_e3fbb5f01b-new-convert-bid-form');
      Main.initForm(state.$convertBidForm);
      Main.initForm(state.$newConvertBidForm);
      state.$convertConfirmPopup = $('.js?xieworld_vf_e3fbb5f01b-convert-confirm-popup');
      state.$moveConfirmPopup = $('.js?xieworld_vf_e3fbb5f01b-move-confirm-popup');
    });
    Aj.onUnload(function(state) {
  ...
  processConverting: function(result) {
    ...
    if (result.state == 'tg_confirm') {
      ...
      if (Aj.state.curPopupState != result.state) {
        ...
        $('.js?xieworld_vf_e3fbb5f01b-username', Aj.state.curPopup).html('@' + result.username);
      ...
      if (Aj.state.curPopupState != result.state) {
        ...
        $('.js?xieworld_vf_e3fbb5f01b-username', Aj.state.curPopup).html('@' + result.username);
        $('.js?xieworld_vf_e3fbb5f01b-address', Aj.state.curPopup).html(result.address);
...
var MyBids = {
  init: function() {
    Aj.onLoad(function(state) {
      $(document).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-load-more-bids', MyBids.eLoadMoreBids);
    });
  },
...
var PremiumHistory = {
  init: function() {
    Aj.onLoad(function(state) {
      $(document).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-load-more-rows', PremiumHistory.eLoadMoreRows);
      Main.initLottie();
    });
    Aj.onUnload(function(state) {
      Main.destroyLottie();
...
var Sessions = {
  init: function() {
    Aj.onLoad(function(state) {
      $(document).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-terminate-btn', Sessions.eTerminate);
    });
  },
...
var Premium = {
  init: function() {
    Aj.onLoad(function(state) {
      var cont = Aj.ajContainer;
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-myself-link', Premium.eAcquireForMyself);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-another-gift-btn', Premium.eGiftMorePremium);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-gift-premium-btn', Premium.eGiftPremium);
      state.$giftPremiumPopup = $('.js?xieworld_vf_e3fbb5f01b-gift-premium-popup');
      $(cont).on('submit.curPage', '.js?xieworld_vf_e3fbb5f01b-gift-premium-form', Premium.eGiftPremiumSubmit);
      state.$giftPremiumForm = $('.js?xieworld_vf_e3fbb5f01b-gift-premium-form');
      Main.initForm(state.$giftPremiumForm);
      state.$premiumSearchField = $('.js?xieworld_vf_e3fbb5f01b-premium-search-field');
      state.$premiumSearchForm = $('.js?xieworld_vf_e3fbb5f01b-premium-form');
      ...
      $('.js?xieworld_vf_e3fbb5f01b-form-clear', state.$premiumSearchForm).on('click', Premium.eSearchClear);
      state.$premiumSearchForm.on('change', '.js?xieworld_vf_e3fbb5f01b-premium-options input.radio', Premium.eRadioChanged);
      state.$giftPremiumForm.on('change', 'input.checkbox', Premium.eCheckboxChanged);
      state.$giftPremiumBtn = $('.js?xieworld_vf_e3fbb5f01b-gift-premium-btn');
      state.updLastReq = +Date.now();
      if (state.needUpdate) {
        state.updStateTo = setTimeout(Premium.updateState, Main.UPDATE_PERIOD);
      }
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-preview-sticker', function() {
        RLottie.playUntilEnd(this);
      });
      $('.js?xieworld_vf_e3fbb5f01b-preview-sticker').each(function() {
    ...
    Aj.onUnload(function(state) {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-form-clear', state.$premiumSearchForm).off('click', Premium.eSearchClear);
      state.$premiumSearchForm.off('change', '.js?xieworld_vf_e3fbb5f01b-premium-options input.radio', Premium.eRadioChanged);
  ...
  eSearchInput: function(e) {
    ...
    $('.js?xieworld_vf_e3fbb5f01b-search-field-error').html('');
  ...
  updateResult: function(result) {
    ...
    var $btn   = Aj.state.$giftPremiumBtn;
    if (result.error) {
      $('.js?xieworld_vf_e3fbb5f01b-search-field-error').html(result.error);
      ...
      if (result.found) {
        if (result.found.photo) {
          $('.js?xieworld_vf_e3fbb5f01b-premium-search-photo', $field).html(result.found.photo);
        }
  ...
  updateOptions: function(html) {
    var $form  = Aj.state.$premiumSearchForm;
    var months = $form.field('months').value();
    $('.js?xieworld_vf_e3fbb5f01b-premium-options').replaceWith(html);
    $form.field('months').value(months);
  },
  updateHistory: function(html) {
    $('.js?xieworld_vf_e3fbb5f01b-premium-history').replaceWith(html);
  },
  updateContent: function(html) {
    $('.js?xieworld_vf_e3fbb5f01b-main-content').html(html).find('.js?xieworld_vf_e3fbb5f01b-preview-sticker').each(function() {
      RLottie.init(this, {playUntilEnd: true});
    });
  },
  eGiftPremium: function(e) {
    ...
    Aj.apiRequest('initGiftPremiumRequest', {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-gift-premium-content', Aj.state.$giftPremiumPopup).html(result.content);
      $('.js?xieworld_vf_e3fbb5f01b-gift-premium-button', Aj.state.$giftPremiumPopup).html(result.button);
...
var PremiumGiveaway = {
  init: function() {
    Aj.onLoad(function(state) {
      var cont = Aj.ajContainer;
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-another-giveaway-btn', PremiumGiveaway.eMoreGiveawayPremium);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-giveaway-premium-btn', PremiumGiveaway.eGiveawayPremium);
      state.$giveawayPremiumPopup = $('.js?xieworld_vf_e3fbb5f01b-giveaway-premium-popup');
      $(cont).on('submit.curPage', '.js?xieworld_vf_e3fbb5f01b-giveaway-premium-form', PremiumGiveaway.eGiveawayPremiumSubmit);
      state.$giveawayPremiumForm = $('.js?xieworld_vf_e3fbb5f01b-giveaway-premium-form');
      state.$premiumSearchField = $('.js?xieworld_vf_e3fbb5f01b-premium-search-field');
      state.$premiumSearchForm = $('.js?xieworld_vf_e3fbb5f01b-premium-form');
      ...
      $('.js?xieworld_vf_e3fbb5f01b-form-clear', state.$premiumSearchForm).on('click', PremiumGiveaway.eSearchClear);
      state.$premiumQuantityField = $('.js?xieworld_vf_e3fbb5f01b-premium-quantity-field');
      state.$premiumSearchForm.field('quantity').on('change', PremiumGiveaway.eQuantityChanged);
      state.$premiumSearchForm.on('change', '.js?xieworld_vf_e3fbb5f01b-premium-options input.radio', PremiumGiveaway.eRadioChanged);
      state.$giveawayPremiumBtn = $('.js?xieworld_vf_e3fbb5f01b-giveaway-premium-btn');
    ...
    Aj.onUnload(function(state) {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-form-clear', state.$premiumSearchForm).off('click', PremiumGiveaway.eSearchClear);
      state.$premiumSearchForm.field('quantity').off('change', PremiumGiveaway.eQuantityChanged);
      state.$premiumSearchForm.off('change', '.js?xieworld_vf_e3fbb5f01b-premium-options input.radio', PremiumGiveaway.eRadioChanged);
  ...
  eQuantityChanged: function() {
    ...
    Aj.apiRequest('updatePremiumGiveawayPrices', {
      ...
      var $btn   = Aj.state.$giveawayPremiumBtn;
      if (result.error) {
        $('.js?xieworld_vf_e3fbb5f01b-quantity-field-error').html(result.error);
        $field.addClass('error').removeClass('found');
        quantity = 0;
      } else {
        $('.js?xieworld_vf_e3fbb5f01b-quantity-field-error').html('');
        $field.removeClass('error');
      }
      $('.js?xieworld_vf_e3fbb5f01b-boost-value').html(result.boosts);
      if (result.button_label) {
        $('.js?xieworld_vf_e3fbb5f01b-prepay-premium-label').html(result.button_label);
      }
      if (result.options_html) {
        PremiumGiveaway.updateOptions(result.options_html);
      }
  ...
  eGiveawayPremium: function(e) {
    ...
    Aj.apiRequest('initGiveawayPremiumRequest', {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-giveaway-premium-content', Aj.state.$giveawayPremiumPopup).html(result.content);
      $('.js?xieworld_vf_e3fbb5f01b-giveaway-premium-button', Aj.state.$giveawayPremiumPopup).html(result.button);
...
var Ads = {
  init: function() {
    Aj.onLoad(function(state) {
      var cont = Aj.ajContainer;
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-pay-for-ads', Ads.ePayForAds);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-howtopay-ton', Ads.eHowToPayTon);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-get-ad-rewards', Ads.eGetAdRewards);
      state.$payForAdsPopup = $('.js?xieworld_vf_e3fbb5f01b-pay-for-ads-popup');
      state.$howToPayTonPopup = $('.js?xieworld_vf_e3fbb5f01b-how-to-pay-ton-popup');
      state.$howToGetRewardsPopup = $('.js?xieworld_vf_e3fbb5f01b-how-to-get-rewards-popup');
    });
  },
  initPay: function() {
    Aj.onLoad(function(state) {
      ...
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-more-funds-btn', Ads.eAddMoreFunds);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-recharge-btn', Ads.eRechargeAccount);
      state.$rechargeForm = $('.js?xieworld_vf_e3fbb5f01b-recharge-form', cont);
      Main.initForm(state.$rechargeForm);
      state.$rechargeBtn = $('.js?xieworld_vf_e3fbb5f01b-recharge-btn', cont);
      state.updLastReq = +Date.now();
  ...
  initTopup: function() {
    Aj.onLoad(function(state) {
      var cont = Aj.ajContainer;
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-myself-link', Ads.eBuyForMyself);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-more-funds-btn', Ads.eTopupMoreFunds);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-ads-topup-btn', Ads.eTopupAccount);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-howtopay-ton', Ads.eHowToPayTon);
      state.$howToPayTonPopup = $('.js?xieworld_vf_e3fbb5f01b-how-to-pay-ton-popup');
      state.$adsTopupPopup = $('.js?xieworld_vf_e3fbb5f01b-ads-topup-popup');
      $(cont).on('submit.curPage', '.js?xieworld_vf_e3fbb5f01b-add-funds-form', Ads.eAddFundsSubmit);
      state.$addFundsForm = $('.js?xieworld_vf_e3fbb5f01b-add-funds-form');
      state.$adsSearchField = $('.js?xieworld_vf_e3fbb5f01b-ads-topup-search-field');
      state.$adsSearchForm = $('.js?xieworld_vf_e3fbb5f01b-ads-topup-form');
      ...
      $('.js?xieworld_vf_e3fbb5f01b-form-clear', state.$adsSearchForm).on('click', Ads.eSearchClear);
      state.$addFundsForm.on('change', 'input.checkbox', Ads.eCheckboxChanged);
      state.$adsTopupBtn = $('.js?xieworld_vf_e3fbb5f01b-ads-topup-btn');
    ...
    Aj.onUnload(function(state) {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-form-clear', state.$adsSearchForm).off('click', Ads.eSearchClear);
  ...
  eTopupAccount: function(e) {
    ...
    Aj.apiRequest('initAdsTopupRequest', {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-add-funds-content', Aj.state.$adsTopupPopup).html(result.content);
      $('.js?xieworld_vf_e3fbb5f01b-add-funds-button', Aj.state.$adsTopupPopup).html(result.button);
  ...
  updateResult: function(result) {
    ...
    if (result.error) {
      ...
      if (result.found) {
        if (result.found.photo) {
          $('.js?xieworld_vf_e3fbb5f01b-search-photo', $field).html(result.found.photo);
        }
        if (result.found.name) {
          var $form = Aj.state.$adsSearchForm;
          $form.field('query').value(uncleanHTML(result.found.name));
  ...
  initWithdraw: function() {
    Aj.onLoad(function(state) {
      ...
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-withdraw-btn', Ads.eWithdrawRevenue);
      state.$withdrawForm = $('.js?xieworld_vf_e3fbb5f01b-withdraw-form', cont);
      Main.initForm(state.$withdrawForm);
      state.$withdrawBtn = $('.js?xieworld_vf_e3fbb5f01b-withdraw-btn', cont);
      state.updLastReq = +Date.now();
      state.canUpdate = true;
      if (state.needUpdate) {
...
var Stars = {
  init: function() {
    Aj.onLoad(function(state) {
      var cont = Aj.ajContainer;
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-myself-link', Stars.eBuyForMyself);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-more-stars-btn', Stars.eBuyMoreStats);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-stars-buy-btn', Stars.eBuyStars);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-more-options', Stars.eShowMoreOptions);
      state.$starsBuyPopup = $('.js?xieworld_vf_e3fbb5f01b-buy-stars-popup');
      $(cont).on('submit.curPage', '.js?xieworld_vf_e3fbb5f01b-buy-stars-form', Stars.eBuyStarsSubmit);
      state.$starsBuyForm = $('.js?xieworld_vf_e3fbb5f01b-buy-stars-form');
      state.$starsSearchField = $('.js?xieworld_vf_e3fbb5f01b-stars-search-field');
      state.$starsSearchForm = $('.js?xieworld_vf_e3fbb5f01b-stars-form');
      ...
      $('.js?xieworld_vf_e3fbb5f01b-form-clear', state.$starsSearchForm).on('click', Stars.eSearchClear);
      state.$starsQuantityField = $('.js?xieworld_vf_e3fbb5f01b-stars-quantity-field');
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-quantity-clear', Stars.eQuantityClear);
      state.$starsSearchForm.field('quantity').on('change', Stars.eQuantityChanged);
      state.$starsSearchForm.on('change', '.js?xieworld_vf_e3fbb5f01b-stars-options input.radio', Stars.eRadioChanged);
      state.$starsBuyForm.on('change', 'input.checkbox', Stars.eCheckboxChanged);
      state.$starsBuyBtn = $('.js?xieworld_vf_e3fbb5f01b-stars-buy-btn');
    ...
    Aj.onUnload(function(state) {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-form-clear', state.$starsSearchForm).off('click', Stars.eSearchClear);
      state.$starsSearchForm.field('quantity').off('change', Stars.eQuantityChanged);
      state.$starsSearchForm.off('change', '.js?xieworld_vf_e3fbb5f01b-stars-options input.radio', Stars.eRadioChanged);
  ...
  clearQuantity: function(need_focus) {
    ...
    $('.js?xieworld_vf_e3fbb5f01b-quantity-field-error').html('');
    $('.js?xieworld_vf_e3fbb5f01b-cur-price').html('');
    Stars.updateButton();
    Stars.updateUrl();
  },
  eQuantityChanged: function() {
    ...
    Aj.apiRequest('updateStarsPrices', {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-cur-price').html(result.cur_price);
      if (result.options_html) {
        Stars.updateOptions(result.options_html);
      }
      if (result.dh) {
      ...
      Aj.state.curStars = 0;
      $('.js?xieworld_vf_e3fbb5f01b-stars-options input.radio:checked').prop('checked', false);
      Stars.updateButton();
      Stars.updateUrl();
    });
  },
  ...
  updateButton: function() {
    ...
    $('.js?xieworld_vf_e3fbb5f01b-stars-btn-label').html(btn_label);
  ...
  updateResult: function(result) {
    ...
    if (result.error) {
      ...
      if (result.found) {
        if (result.found.photo) {
          $('.js?xieworld_vf_e3fbb5f01b-stars-search-photo', $field).html(result.found.photo);
        }
        if (result.found.name) {
          var $form = Aj.state.$starsSearchForm;
          $form.field('query').value(uncleanHTML(result.found.name));
  ...
  updateOptions: function(html) {
    var $form  = Aj.state.$starsSearchForm;
    var stars = $form.field('stars').value();
    $('.js?xieworld_vf_e3fbb5f01b-stars-options').replaceWith(html);
    $form.field('stars').value(stars);
    $('.js?xieworld_vf_e3fbb5f01b-stars-options .tm-second-option:has(input:checked)').removeClass('tm-second-option');
  },
  eBuyStars: function(e) {
    ...
    Aj.apiRequest('initBuyStarsRequest', {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-buy-stars-content', Aj.state.$starsBuyPopup).html(result.content);
      $('.js?xieworld_vf_e3fbb5f01b-buy-stars-button', Aj.state.$starsBuyPopup).html(result.button);
  ...
  initWithdraw: function() {
    Aj.onLoad(function(state) {
      var cont = Aj.ajContainer;
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-withdraw-btn', Stars.eWithdrawRevenue);
      state.$withdrawForm = $('.js?xieworld_vf_e3fbb5f01b-withdraw-form', cont);
      Main.initForm(state.$withdrawForm);
      state.$withdrawBtn = $('.js?xieworld_vf_e3fbb5f01b-withdraw-btn', cont);
      state.updLastReq = +Date.now();
...
var StarsGiveaway = {
  init: function() {
    Aj.onLoad(function(state) {
      var cont = Aj.ajContainer;
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-another-giveaway-btn', StarsGiveaway.eMoreGiveawayStars);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-giveaway-stars-btn', StarsGiveaway.eGiveawayStars);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-more-options', StarsGiveaway.eShowMoreOptions);
      state.$giveawayStarsPopup = $('.js?xieworld_vf_e3fbb5f01b-giveaway-stars-popup');
      $(cont).on('submit.curPage', '.js?xieworld_vf_e3fbb5f01b-giveaway-stars-form', StarsGiveaway.eGiveawayStarsSubmit);
      state.$giveawayStarsForm = $('.js?xieworld_vf_e3fbb5f01b-giveaway-stars-form');
      state.$starsSearchField = $('.js?xieworld_vf_e3fbb5f01b-stars-search-field');
      state.$starsSearchForm = $('.js?xieworld_vf_e3fbb5f01b-stars-form');
      ...
      $('.js?xieworld_vf_e3fbb5f01b-form-clear', state.$starsSearchForm).on('click', StarsGiveaway.eSearchClear);
      state.$starsQuantityField = $('.js?xieworld_vf_e3fbb5f01b-stars-quantity-field');
      state.$starsSearchForm.field('quantity').on('change', StarsGiveaway.eQuantityChanged);
      state.$starsSearchForm.on('change', '.js?xieworld_vf_e3fbb5f01b-stars-options input.radio', StarsGiveaway.eRadioChanged);
      state.$giveawayStarsBtn = $('.js?xieworld_vf_e3fbb5f01b-giveaway-stars-btn');
      state.$starsBuyBtn = $('.js?xieworld_vf_e3fbb5f01b-stars-buy-btn');
      state.curQuantity = state.$starsSearchForm.field('quantity').value();
      state.updLastReq = +Date.now();
      if (state.needUpdate) {
    ...
    Aj.onUnload(function(state) {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-form-clear', state.$starsSearchForm).off('click', StarsGiveaway.eSearchClear);
      state.$starsSearchForm.field('quantity').off('change', StarsGiveaway.eQuantityChanged);
      state.$starsSearchForm.off('change', '.js?xieworld_vf_e3fbb5f01b-stars-options input.radio', StarsGiveaway.eRadioChanged);
  ...
  eQuantityChanged: function() {
    ...
    Aj.apiRequest('updateStarsGiveawayPrices', {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-per-user-value').html(result.per_user);
  ...
  eRadioChanged: function(e) {
    ...
    $('.js?xieworld_vf_e3fbb5f01b-boost-value').html(boosts);
  ...
  eGiveawayStars: function(e) {
    ...
    Aj.apiRequest('initGiveawayStarsRequest', {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-giveaway-stars-content', Aj.state.$giveawayStarsPopup).html(result.content);
      $('.js?xieworld_vf_e3fbb5f01b-giveaway-stars-button', Aj.state.$giveawayStarsPopup).html(result.button);
      Aj.state.giveawayPrice = result.amount;
      Aj.state.itemTitle = result.item_title;
...
var Gateway = {
  init: function() {
    Aj.onLoad(function(state) {
      ...
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-more-funds-btn', Gateway.eAddMoreFunds);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-recharge-btn', Gateway.eRechargeAccount);
      state.$rechargeForm = $('.js?xieworld_vf_e3fbb5f01b-recharge-form', cont);
      Main.initForm(state.$rechargeForm);
      state.$rechargeForm.on('submit', Gateway.eAmountChanged);
      state.$curPrice = $('.js?xieworld_vf_e3fbb5f01b-cur-price', cont);

      state.$amountField = $('.js?xieworld_vf_e3fbb5f01b-credits-quantity-field');
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-quantity-clear', Gateway.eQuantityClear);
...
var Nft = {
  initTransfer: function() {
    Aj.onLoad(function(state) {
      var cont = Aj.ajContainer;
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-myself-link', Nft.eMoveToMyself);
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-nft-transfer-btn', Nft.eTransferNft);
      state.$nftTransferPopup = $('.js?xieworld_vf_e3fbb5f01b-nft-transfer-popup');
      $(cont).on('submit.curPage', '.js?xieworld_vf_e3fbb5f01b-nft-transfer-form', Nft.eNftTransferSubmit);
      state.$nftTransferForm = $('.js?xieworld_vf_e3fbb5f01b-nft-transfer-form');
      Main.initForm(state.$nftTransferForm);
      state.$nftTransferSearchField = $('.js?xieworld_vf_e3fbb5f01b-nft-transfer-search-field');
      state.$nftTransferSearchForm = $('.js?xieworld_vf_e3fbb5f01b-nft-transfer-search-form');
      ...
      $('.js?xieworld_vf_e3fbb5f01b-form-clear', state.$nftTransferSearchForm).on('click', Nft.eSearchClear);
      state.$nftTransferForm.on('change', 'input.checkbox', Nft.eCheckboxChanged);
      state.$nftTransferBtn = $('.js?xieworld_vf_e3fbb5f01b-nft-transfer-btn');
      state.updLastReq = +Date.now();
      if (state.needUpdate) {
    ...
    Aj.onUnload(function(state) {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-form-clear', state.$nftTransferSearchForm).off('click', Nft.eSearchClear);
  ...
  updateResult: function(result) {
    ...
    if (result.error) {
      ...
      if (result.found) {
        if (result.found.photo) {
          $('.js?xieworld_vf_e3fbb5f01b-nft-transfer-search-photo', $field).html(result.found.photo);
        }
        if (result.found.name) {
          var $form = Aj.state.$nftTransferSearchForm;
          $form.field('query').value(uncleanHTML(result.found.name));
  ...
  eTransferNft: function(e) {
    ...
    Aj.apiRequest('initNftTransferRequest', {
      ...
      $('.js?xieworld_vf_e3fbb5f01b-nft-transfer-content', Aj.state.$nftTransferPopup).html(result.content);
      $('.js?xieworld_vf_e3fbb5f01b-nft-transfer-button', Aj.state.$nftTransferPopup).html(result.button);
  ...
  initWithdraw: function() {
    Aj.onLoad(function(state) {
      var cont = Aj.ajContainer;
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-withdraw-btn', Nft.eWithdrawNft);
      state.$withdrawForm = $('.js?xieworld_vf_e3fbb5f01b-withdraw-form', cont);
      Main.initLottie();
      Main.initForm(state.$withdrawForm);
      state.$withdrawBtn = $('.js?xieworld_vf_e3fbb5f01b-withdraw-btn', cont);
  ...
  updateContent: function(html) {
    $('.js?xieworld_vf_e3fbb5f01b-main-content .js?xieworld_vf_e3fbb5f01b-lottie').each(function() {
      RLottie.destroy(this);
    });
    $('.js?xieworld_vf_e3fbb5f01b-main-content').html(html).find('.js?xieworld_vf_e3fbb5f01b-lottie').each(function() {
      RLottie.init(this);
    });
  },
...
var Profile = {
  init: function() {
    Aj.onLoad(function(state) {
      var cont = Aj.ajContainer;
      $(cont).on('click.curPage', '.js?xieworld_vf_e3fbb5f01b-wallet-verify-btn', Profile.eVerifyWallet);
    });
  },
...
var Verify = {
      ...
      var kycInstance = snsWebSdk
        ...
        .on('idCheck.onApplicantStatusChanged', (payload) => {
          ...
          if (payload.reviewStatus == 'completed') {
            ...
            $('.js?xieworld_vf_e3fbb5f01b-kyc-buttons').show();
          } else {
            $('.js?xieworld_vf_e3fbb5f01b-kyc-buttons').hide();
          }
        })
        .build();
  ...
  showPopup: function(data, callback) {
    ...
    $($confirm).on('click', '.js?xieworld_vf_e3fbb5f01b-wallet-check-btn', function(e) {
      Verify.checkWallet($confirm, callback);
    });
    $($confirm).on('click', '.js?xieworld_vf_e3fbb5f01b-wallet-link-btn', function(e) {
      Verify.linkWallet($confirm, callback);
    });
    $('.popup-body', $confirm).html(data.popup);
    $confirm.one('popup:close', function() {
      $($confirm).off('click', '.js?xieworld_vf_e3fbb5f01b-wallet-check-btn');
      $($confirm).off('click', '.js?xieworld_vf_e3fbb5f01b-wallet-link-btn');
      $confirm.remove();
    });
    openPopup($confirm);
    return $confirm;
...
var QR = {
  showPopup: function(options) {
    ...
    var $tonkeeperBtn = $('.js?xieworld_vf_e3fbb5f01b-tonkeeper-btn', $popup);
    var $confirmedBtn = $('.js?xieworld_vf_e3fbb5f01b-confirmed-btn', $popup);
    var tkOpen = function() {
    ...
    var setData = function(data, req) {
      QR.getUrl(data.qr_link, function(url) {
        ...
        $qrCode.css?xieworld_vf_e3fbb5f01b('backgroundImage', "url('" + url + "')");
