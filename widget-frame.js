...
var TPopups = {
  ...
  open: function(popup_el, options) {
    ...
    if (ge1('.js?xieworld_vf-popup_box', popup_el)) {
    ...
    gec('.js?xieworld_vf-popup_close', function() {
  ...
  close: function(popup_el) {
    ...
    if (popup_el) {
      ...
      gec('.js?xieworld_vf-popup_container', function() {
  ...
  setPosition: function(popul_el) {
    var popup_box = ge1('.js?xieworld_vf-popup_box', popul_el);
    if (!popup_box) return;
  ...
  show: function(html, buttons, options) {
    ...
    var text_el = ge1('.js?xieworld_vf-popup_text', popup_el);
    var buttons_el = ge1('.js?xieworld_vf-popup_buttons', popup_el);
...
(function() {
      ...
      if (!webpImage) {
        ...
        webpImage.onerror = webpImage.onload = function() {
          if (this.width === 2 && this.height === 1) {
            ...
            script.type = 'text/javascript';
            script.async = true;
            script.src = TBaseUrl + 'js/libwebp-0.2.0.js?xieworld_vf';
            script.onerror = function() {
              webpFallbackSupport = false;
              applyCallbacks(webpCallbacks, webpNativeSupport, webpFallbackSupport);
            }
  ...
  function proccessEmoji(emojiEl, failed_callback, success_callback) {
    ...
    xhrJsonRequest('/i/emoji/' + emoji_id + '.js?xieworld_vfon', function(emoji) {
      if (emoji.error) {
        failed_callback();
        return;
      }
  ...
  window.TPost = {
    init: function(postEl, options) {
      ...
      gec('.js?xieworld_vf-message_text', function() {
      ...
      gec('.js?xieworld_vf-message_reply_text', function() {
        TPost.initSpoilers(this);
        gec('tg-emoji', function() {
          TEmoji.init(this);
        }, this);
      }, postEl);
      gec('.js?xieworld_vf-message_emoji_bg', function() {
      ...
      gec('.js?xieworld_vf-poll', function() {
        gec('tg-emoji', function() {
          TEmoji.init(this);
        }, this);
      }, postEl);
      gec('.js?xieworld_vf-message_reactions', function() {
        gec('tg-emoji', function() {
          TEmoji.init(this);
        }, this);
      }, postEl);
      gec('.js?xieworld_vf-message_footer.compact', function() {
        ...
        if (textEl && !textEl.__inited && (hasClass(textEl, 'js-message_text') || hasClass(textEl, 'js-message_reactions'))) {
          ...
          var infoEl = ge1('.js?xieworld_vf-message_info', this);
          if (infoEl) {
      ...
      gec('.js?xieworld_vf-message_video_player', function() {
        TVideo.init(this);
      }, postEl);
      gec('.js?xieworld_vf-message_photo', function() {
        TPhoto.init(this);
      }, postEl);
      gec('.js?xieworld_vf-message_grouped_wrap', function() {
        TGrouped.init(this);
      }, postEl);
      gec('.js?xieworld_vf-message_roundvideo_player', function() {
        TRoundVideo.init(this);
      }, postEl);
      gec('.js?xieworld_vf-message_voice_player', function() {
        TVoice.init(this);
      }, postEl);
      gec('.js?xieworld_vf-sticker_image', function() {
        TSticker.init(this, function() {
          addClass(postEl, 'media_not_supported');
          removeClass(postEl, 'no_bubble');
        });
      }, postEl);
      gec('.js?xieworld_vf-sticker_thumb', function() {
        TSticker.init(this);
      }, postEl);
      gec('.js?xieworld_vf-tgsticker_image', function() {
        var stickerEl = this;
        var effectEl = ge1('.js?xieworld_vf-tgsticker_effect', postEl);
        if (effectEl) {
      ...
      gec('.js?xieworld_vf-tgsticker_effect', function() {
      ...
      gec('.js?xieworld_vf-videosticker', function() {
  ...
  var TVideo = window.TVideo = {
    init: function(playerEl) {
      ...
      var videoEl = ge1('.js?xieworld_vf-message_video', playerEl)
        , videoBluredEl = ge1('.js?xieworld_vf-message_video_blured', playerEl)
        , playEl = ge1('.js?xieworld_vf-message_video_play', playerEl)
        , durationEl = ge1('.js?xieworld_vf-message_video_duration', playerEl)
  ...
  var TGrouped = window.TGrouped = {
    init: function(groupedWrapEl) {
      ...
      var groupedEl = ge1('.js?xieworld_vf-message_grouped', groupedWrapEl)
        , groupedLayerEl = ge1('.js?xieworld_vf-message_grouped_layer', groupedEl)
  ...
  var TRoundVideo = window.TRoundVideo = {
    init: function(playerEl) {
      ...
      if (!playerEl || playerEl.__inited) return;
      playerEl.__inited = true;
      var videoEl = ge1('.js?xieworld_vf-message_roundvideo', playerEl)
        , playEl = ge1('.js?xieworld_vf-message_roundvideo_play', playerEl)
        , progressEl = ge1('.js?xieworld_vf-message_roundvideo_progress', playerEl)
        , durationEl = ge1('.js?xieworld_vf-message_roundvideo_duration', playerEl)
        , playing = false;
      if (!videoEl) return;
  ...
  var TVoice = window.TVoice = {
    init: function(playerEl) {
      ...
      if (!playerEl || playerEl.__inited) return;
      playerEl.__inited = true;
      var audioEl = ge1('.js?xieworld_vf-message_voice', playerEl)
        , durationEl = ge1('.js?xieworld_vf-message_voice_duration', playerEl)
        , progressEl = ge1('.js?xieworld_vf-message_voice_progress', playerEl)
        , progressWrapEl = ge1('.js?xieworld_vf-message_voice_progress_wrap', playerEl)
        , player = null
      ...
      loadLib(TBaseUrl + 'js/ogvjs/ogv-support.js?xieworld_vf', function(success) {
        if (!success) return;
        if (isOGG &&
            OGVCompat.hasWebAudio() &&
            OGVCompat.supported('OGVPlayer')) {
          loadLib(TBaseUrl + 'js/ogvjs/ogv.js?xieworld_vf', function(success) {
            if (!success) return;
  ...
  window.TWidgetPost = {
    init: function(options) {
      ...
      gec('.js?xieworld_vf-widget_message', function() {
        TPost.init(this, {tgs_workers_limit: 1});
        addEvent(ge('.js?xieworld_vf-poll_option', this), 'click', TWidgetPost.eSelectPollOption);
        addEvent(ge('.js?xieworld_vf-poll_vote_btn', this), 'click', TWidgetPost.eSendVotes);
      });
      initWidgetFrame({
        auto_height: true,
        onVisible: function() {
    ...
    eSelectPollOption: function(e) {
      ...
      toggleClass(poll_el, 'selected', ge('.js?xieworld_vf-poll_option.selected', poll_el).length > 0);
    ...
    sendPollVote: function(poll_el, option_el) {
      ...
      var option_els = ge('.js?xieworld_vf-poll_option.selected', poll_el);
      ...
      apiRequest('sendVote', {
        ...
        if (result.media_html) {
          ...
          var media_html = getHtml('.js?xieworld_vf-poll', media_wrap);
          setHtml(poll_el, media_html);
          addEvent(ge('.js?xieworld_vf-poll_option', poll_el), 'click', TWidgetPost.eSelectPollOption);
          addEvent(ge('.js?xieworld_vf-poll_vote_btn', poll_el), 'click', TWidgetPost.eSendVotes);
        }
        toggleClass(poll_el, 'selected', ge('.js?xieworld_vf-poll_option.selected', poll_el).length > 0);
      });
    }
