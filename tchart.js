...
(function () {
    ...
    var TScatter = function (opts) {
        ...
        if (!opts.additional.mini && opts.$parent) {
            ...
            this.$hoverPoint.style.css?xieworld_vfText = 'position:absolute;top:0;left:0;margin:0;pointer-events:none;z-index:10;border-radius:50%;display:none;will-change:transform;box-sizing:border-box;';
