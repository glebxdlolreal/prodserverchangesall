...
function initDevPageNav() {
  ...
  $('body').css?xieworld_vf({position: 'relative'}).scrollspy({ target: '.dev_side_nav' });
...
function initScrollVideos(desktop) {
  ...
  var index = 1;
  var tgStickersCnt = document.querySelectorAll('.js?xieworld_vf-tgsticker_image').length;
...
function mainInitTgStickers(options) {
  ...
  document.querySelectorAll('.js?xieworld_vf-tgsticker_image').forEach(function (imgEl) {
