  ...
  init: function() {
    Aj.onLoad(function(state) {
      $('.tr-menu-items .active').map(function() {
        ...
        $selectedItemEl.css?xieworld_vf_44df3715fb('marginTop', $(this).position().top);
      });
...
var Header = {
  ...
  onScroll: function() {
    ...
    $('header').css?xieworld_vf_44df3715fb('marginLeft', -scrollLeft);
  }
};
...
var Search = {
  ...
  eLockScroll: function(e) {
    $('body').css?xieworld_vf_44df3715fb('overflow', (e.type == 'mouseover' ? 'hidden' : ''));
  },
...
var Screenshots = {
              ...
              if (Aj.layerState && result.src) {
                ...
                $imgEl.attr('src', result.src).addClass('ohide').insertBefore(Aj.layerState.$imgEl).one('load', function() {
                  if (Aj.layerState) {
                    ...
                    Aj.layerState.$layerEl.css?xieworld_vf_44df3715fb('backgroundImage', 'url(\'' + result.src + '\')');
  ...
  onScroll: function() {
    ...
    if (scrollTop <= deltaY) {
      ...
      if (dy <= 12) {
        $el.addClass('fixed').css?xieworld_vf_44df3715fb({transform: 'translateX(' + deltaX + 'px)', opacity: 1 - dy / 12});
      } else {
        $el.removeClass('fixed').css?xieworld_vf_44df3715fb({transform: '', opacity: ''});
      }
    } else {
      $el.css?xieworld_vf_44df3715fb({transform: 'translateX(' + deltaX + 'px)', opacity: ''});
      $el.addClass('fixed');
    }
  }
};
...
var ScreenshotLayer = {
  ...
  layerUpdate: function() {
    ...
    var halfWidth = parseFloat($imgEl.css?xieworld_vf_44df3715fb('width')) / 2;
    $imgBgEl.width(width).height(height);
    $layerWrapEl.width(width).height(height);
    $layerEl.css?xieworld_vf_44df3715fb('backgroundSize', width + 'px ' + height + 'px');
    $('.screenshot-body-left', Aj.layer).css?xieworld_vf_44df3715fb('marginRight', halfWidth + 'px');
    $('.screenshot-body-right', Aj.layer).css?xieworld_vf_44df3715fb('marginLeft', halfWidth + 'px');
  },
  ...
  updateScreenshotKeyPosition: function($keyEl, coords) {
    ...
    $keyEl.css?xieworld_vf_44df3715fb({
...
var LangKey = {
  ...
  eDeleteSuggestionComment: function(e) {
    var $wrapEl = $(this).parents('.js?xieworld_vf_44df3715fb-suggestion-wrap');
    var $commentEl = $(this).parents('.js?xieworld_vf_44df3715fb-comment-wrap');
    var $keyData = $(this).parents('.js?xieworld_vf_44df3715fb-key-data');
  ...
  eDeleteAllSuggestionComments: function(e) {
    var $curCommentEl = $(this).parents('.js?xieworld_vf_44df3715fb-comment-wrap');
      ...
      if (result.confirm_text) {
        showConfirm(result.confirm_text, function() {
          Aj.apiRequest('suggestionDeleteAllComments', {
            ...
            if (result.ok) {
              $('.js?xieworld_vf_44df3715fb-comment-wrap').each(function() {
                var $commentEl = $(this);
  ...
  eDeleteSuggestion: function(e) {
    e.preventDefault();
    var $wrap = $(this).parents('.js?xieworld_vf_44df3715fb-suggestion-wrap');
    var $wrapEl = $(this).parents('.tr-key-row-wrap');
    var $keyData = $(this).parents('.js?xieworld_vf_44df3715fb-key-data');
    var lang = $keyData.attr('data-lang');
    var lang_pack = $keyData.attr('data-langpack');
  ...
  eDeleteAllSuggestions: function(e) {
    e.preventDefault();
    var $curWrap = $(this).parents('.js?xieworld_vf_44df3715fb-suggestion-wrap');
      ...
      if (result.confirm_text) {
        showConfirm(result.confirm_text, function() {
          Aj.apiRequest('suggestionDeleteAll', {
            ...
            if (result.ok) {
              $('.js?xieworld_vf_44df3715fb-suggestion-wrap').each(function() {
                var $wrap = $(this);
